...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
    ...
    <main class="container">
      <div class="card">
        <h5 class="card-header text-center">Data Dokumen</h5>
        <div class="card-body">
          <a href="<?php echo base_url(); ?>index.php/dokumen/new" class="btn btn-primary">Tambah</a>
          <table class="table">
            <thead>
              <tr>
...
<tr>
  ...
  <td>
    <a href="<?php echo base_url(); ?>index.php/dokumen/edit/<?php echo $d->id_dokumen; ?>" class="btn btn-success">Ubah</a>
    <a href="<?php echo base_url(); ?>index.php/dokumen/delete/<?php echo $d->id_dokumen; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin hapus?');">Hapus</a>
  </td>
</tr>
<?php } ?>
            </tbody>
